 ...
 %>
  <table width="300" border="1">
    ...
    <tr>
      ...
      <input type="text" style="background:none;border:0;" name="xz_answer" id="textfield" /></td>
 ...
 %>
  <table width="300" border="1">
    ...
    <tr>
      <td height="50">答案
        <label for="textfield"></label>
      <input type="text" style="background:none;border:0;" name="pd_answer" id="textfield"/></td>
 ...
 %>
  <table width="300" border="1">
    ...
    <tr>
      <td height="50">答案
        <label for="textfield"></label>
      <input type="text" style="background:none;border:0;" name="jd_answer" id="textfield"/></td>
  ...
  <p>
    <input type="submit" name="button" id="button"  value="提交试卷" />
  </p>
</form>
